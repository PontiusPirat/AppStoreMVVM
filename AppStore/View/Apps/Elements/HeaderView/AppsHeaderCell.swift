...
class AppsHeaderCell: UICollectionViewCell {
    ...
    var headerData: Header! {
        didSet {
            ...
            if let iconURL = URL(string: headerData.imageUrl) {
                print("IMAGE: \(iconURL)")
                appImage.kf.setImage(with: iconURL)
            } else {
    ...
    var appDescription = UILabel(text: "App Description more text and other and other", font: .systemFont(ofSize: 20), numberOfLines: 2)
